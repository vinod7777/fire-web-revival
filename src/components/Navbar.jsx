            ...
            <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 50 }} transition={{ duration: 0.4, delay: 0.2 }} className="flex flex-col justify-center">
              <div className="bg-card/50 border border-primary/20 rounded-2xl p-6 md:p-8">
                ...
                <div className="flex gap-4 mb-8">
                  <a
                    href="https://www.instagram.com/avishkaar.aitam/?hl=en"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/school/aitamofficial/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-muted rounded-lg flex items-center justify-center hover:bg-primary/20 hover:text-primary transition-colors"
                    aria-label="LinkedIn"
                  ...
                  <a
                    href="https://www.youtube.com/@aitamofficial"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-muted rounded-lg flex items-center justify-center hover:bg-primary/20 hover:text-primary transition-colors"
                    aria-label="YouTube"
